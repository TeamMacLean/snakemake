...
It is important to generate logs for our snakemake rules and steps within, as this will make troubleshooting easier.  To do this you can add the `log` attribute to each rule. 
